 ...
 * 
 * @author Cai & Lee
 * This class is the guess number game.
 *
 */
public class functionGuessNumber {
	private int number1;
	private int count;
	private JPanel jpEscape;
	private JPanel jpBack1;
	private JPanel jpNext;
	private JPanel jpFinish;
	private JPanel jpReason;
	private JPanel jpHint;
