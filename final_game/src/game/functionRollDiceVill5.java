 ...
 * 
 * @author Cai & Lee
 * This class is the roll the dice game for villain 5, it will
 * guess number after play roll the dice.
 *
 */
public class functionRollDiceVill5 {
	...
	static int rollClick=0;//an integer to count the how many time player has clicked the roll button
	...
	public static void addRoll(Container con, heroable hero,JLabel villHp,JLabel heroHp, JPanel jpVill, JPanel jpHero,
		...
		roll.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(rollClick == 2 && isFinished == false) {
					rollClick = 0;
					setVisible();
					new functionGuessNumberVill5().addGuss(con, hero, villHp, heroHp, 
							jpVill, jpHero, jpLairHP, jpHeroHP, hpIcon1, hpIcon2, 
							lair.heroIndex,GImage1,GImage2,lair.thisVill,lair.villIndex,GImage);
				}
			}
		});
	...
	/**
	 * before playing guess number, set some panel is not visible.
	 */
