 ...
 * 
 * @author Cai & Lee
 * This class is the guess number game for villain 5.
 *
 */
public class functionGuessNumberVill5 {
	int number1;
	int count;
	JPanel jpBack1;
	JPanel jpNext;
	...
	public void addGuss(Container container, heroable hero,JLabel villHp,JLabel heroHp, JPanel jpVill, JPanel jpHero,
			...
			JPanel GImage1,JPanel GImage2, allVills thisVill,int villIndex,JPanel GImage) {
		random();
		new powerUpDen();
		new bag();
		...
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				functionRollDiceVill5.jpHeroNumber.setVisible(false);
				functionRollDiceVill5.jpVillNumber.setVisible(false);
